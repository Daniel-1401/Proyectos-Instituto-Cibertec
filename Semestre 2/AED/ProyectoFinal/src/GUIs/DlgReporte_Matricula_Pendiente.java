...
public class DlgReporte_Matricula_Pendiente extends JDialog implements ActionListener, MouseListener, KeyListener, MouseMotionListener {
	...
	public DlgReporte_Matricula_Pendiente() {
		...
		lblNewLabel.setBounds(35, 44, 329, 22);
		contentPanel.add(lblNewLabel);
		
		lblNewLabel = new JLabel("REPORTE | PENDIENTE");
		...
		btnListar.setBounds(361, 45, 110, 40);
		btnListar.addActionListener(this);
		contentPanel.add(btnListar);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(32, 92, 724, 384);
